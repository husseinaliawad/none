...
class UpdateEmbeddedVideoRequest extends FormRequest
{
    ...
    {
        $videoId = optional($this->route('video'))->id;

        return [
            'title' => ['required', 'string', 'max:255'],
            'slug' => ['nullable', 'string', 'max:255', Rule::unique('embedded_videos', 'slug')->ignore($videoId)],
